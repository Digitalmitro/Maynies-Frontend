  ...
  return (
    ...
    {thank ? (
      ...
      <>
        <div className="relative w-full">
          ...
          <motion.h2
            ...
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
              font-semibold text-3xl sm:text-4xl md:text-[40px] z-20 text-center"
          >
            Contact Us
          </motion.h2>
        </div>
        
        <div className="flex flex-col lg:flex-row justify-center items-center px-4 sm:px-8 md:px-20 py-12 md:py-[100px] w-full gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: false }}
            className="space-y-4 w-full lg:w-[40%] flex flex-col justify-center lg:pl-4 xl:pl-20"
          >
            <h4 className="text-lg sm:text-xl font-semibold">Way to reach us:</h4>
            <p className="text-[#00953B]">+1 405 638-5343</p>
            <p className="text-[#00953B]">maynies05@gmail.com</p>
            <p>Monday-Friday 9:00am-5:00pm MST</p>
            <h4 className="text-lg sm:text-xl font-semibold pt-2">
              Head Office & Mailing Address:
            </h4>
            <p className="w-full sm:w-[200px]">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: false }}
            className="rounded-lg overflow-hidden flex justify-center items-center w-full lg:w-[60%] h-[300px] sm:h-[350px]"
          >
            <iframe
        ...
        <div className="bg-[#EDECEC] w-full px-4 sm:px-8 md:px-20 py-8 md:py-[50px] space-y-2">
          <motion.h2
            className="text-xl sm:text-2xl md:text-[25px] font-semibold text-[#FE9900]"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false, amount: 0.5 }}
            transition={{ duration: 0.6 }}
          ...
          >
            <input
              ...
              className="outline-1 outline-gray-500 px-4 w-full sm:w-[48%] py-2 rounded"
            />
            <input
              type="text"
    ...
    <div className="px-4 sm:px-10 py-5 bg-white w-full">
      <motion.div
      ...
      >
        <img src={about_4} alt="" className="w-full md:w-[60%] lg:w-[40%]" />
        <p className="text-center px-2 sm:px-10 text-sm sm:text-base">
      ...
      {/* Review Cards */}
      <motion.div
        className="flex flex-col sm:flex-row flex-wrap justify-center sm:justify-evenly gap-8 py-8"
        initial="hidden"
        whileInView="visible"
        variants={{
          hidden: {},
