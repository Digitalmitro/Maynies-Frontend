    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-md p-6 bg-white rounded-lg shadow-md text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">Error Loading Plan</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-md p-6 bg-white rounded-lg shadow-md text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">Plan Not Found</h2>
          ...
          <div className="p-6">
            ...
            <div className="mt-8 border-t pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                >
                  <div className="flex items-start">
                    <div
                      className={`mt-1 mr-3 w-5 h-5 rounded-full border flex items-center justify-center ${
                        paymentMode === "one_time"
                    ...
                    <div>
                      <h4 className="font-medium text-left">One-time Payment</h4>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-left">Installments</h4>
                      <p className="text-sm text-gray-600 text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              <button
                ...
                className="px-6 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none disabled:opacity-50 flex items-center justify-center min-w-32"
              >
                {enrollLoading ? (
                  <>
...
export default StudentPlainDetails;