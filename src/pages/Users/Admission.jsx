  ...
  <div className="w-full max-w-6xl bg-white rounded-2xl p-1 md:p-6 space-y-6">
    ...
    <div className="flex items-center justify-between flex-wrap gap-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold">Admission Form</h2>
          <p className="text-sm text-gray-500">
            Drop your file here or <span className="text-orange-500">browser</span>
          </p>
        </div>
      </div>
    ...
    {/* Student Details */}
    <h3 className="text-base sm:text-lg font-semibold text-orange-600">Student Details</h3>
    ...
    {/* Academic Details */}
    <h3 className="text-base sm:text-lg font-semibold text-orange-600">Academic Details</h3>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {[
        ["institute", "Institute"],
    ...
    {/* Parent / Guardian */}
    <h3 className="text-base sm:text-lg font-semibold text-orange-600">Parent / Guardian Details</h3>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {[
        ["first_name", "First Name"],
        ["last_name", "Last Name"],
    ...
    {/* Documents */}
    <h3 className="text-base sm:text-lg font-semibold text-orange-600">Documents</h3>
